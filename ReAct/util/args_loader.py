...
def get_args():
    ...
    parser.add_argument('--out-datasets', default=['oxford_flowers'], type=list, help="['SVHN', 'LSUN', 'LSUN_resize', 'iSUN', 'dtd', 'places365']  ['inat', 'sun50', 'places50', 'dtd', ]")
    ...
    parser.add_argument('--method', default='react', type=str, help='odin mahalanobis CE_with_Logst')
