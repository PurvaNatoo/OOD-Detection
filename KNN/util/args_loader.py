...
def get_args():
    ...
    parser.add_argument('--out-datasets', default=['dtd', 'LSUN', 'iSUN'], nargs="*", type=str, help="['SVHN', 'LSUN', 'iSUN', 'dtd', 'places365']  ['inat', 'sun50', 'places50', 'dtd', ]")
    ...
    parser.add_argument('--method', default='energy', type=str, help='')
